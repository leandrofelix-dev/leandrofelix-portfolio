<p align="center">
  <img src="https://github.com/leandrofelix-dev/portfolio/assets/75434191/44252d99-9dff-4e5f-9bec-819e3fca7fb3"  alt="Muhammad Fiaz's Portfolio"/>
</p>
...
[![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-blue)](https://github.com/leandrofelix-dev/portfolio)
[![Build Passing](https://badge.buildkite.com/sample.svg?status=passing)](https://github.com/leandrofelix-dev/portfolio)
[![Continuous Integration](https://github.com/leandrofelix-dev/portfolio/actions/workflows/prettier.yml/badge.svg)](https://github.com/leandrofelix-dev/portfolio/actions/workflows/prettier.yml)
[![CodeQL](https://github.com/leandrofelix-dev/portfolio/actions/workflows/codeql.yml/badge.svg)](https://github.com/leandrofelix-dev/portfolio/actions/workflows/codeql.yml)
[![CodeSee](https://github.com/leandrofelix-dev/portfolio/actions/workflows/codesee-arch-diagram.yml/badge.svg)](https://github.com/leandrofelix-dev/portfolio/actions/workflows/codesee-arch-diagram.yml)
[![Dependency Review](https://github.com/leandrofelix-dev/portfolio/actions/workflows/dependency-review.yml/badge.svg)](https://github.com/leandrofelix-dev/portfolio/actions/workflows/dependency-review.yml)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://GitHub.com/leandrofelix-dev/portfolio)
[![Maintainer](https://img.shields.io/badge/maintainer-muhammadfiaz-blue)](https://GitHub.com/leandrofelix-dev)

[![Latest Release](https://img.shields.io/github/release/leandrofelix-dev/portfolio.svg)](https://github.com/leandrofelix-dev/portfolio/releases/latest)
[![Current Version](https://img.shields.io/badge/Current%20Version-v1.0.7-blue.svg)](https://github.com/leandrofelix-dev/portfolio/releases/tag/v1.0.7)
...
This project is built with Next.js and React, showcasing [Muhammad Fiaz](https://github.com/leandrofelix-dev/)'s personal website.

**Feel free to use this project for your own portfolio or as a reference for your projects. If you find it helpful, don't forget to give it a ⭐️ to show your support. [Fork this repo](https://github.com/leandrofelix-dev/portfolio/fork) if you want to contribute✨**
...
For a detailed list of releases and changes, please visit the [GitHub Releases page](https://github.com/leandrofelix-dev/portfolio/releases).

You can also refer to the [CHANGELOG.md](./CHANGELOG.md) file for comprehensive information about each release.

if you have any suggestions or feedback, feel free to open an [issue](https://github.com/leandrofelix-dev/portfolio/issues) or a [pull request](https://github.com/leandrofelix-dev/portfolio/pulls).

## Getting Started

To run the project locally, follow these steps:

1. Clone the repository: `git clone https://github.com/leandrofelix-dev/portfolio.git`
...
[![Sponsor leandrofelix-dev](https://img.shields.io/badge/Sponsor-%231EAEDB.svg?&style=for-the-badge&logo=GitHub-Sponsors&logoColor=white)](https://github.com/sponsors/leandrofelix-dev)
...
✅ See [latest release](https://github.com/leandrofelix-dev/portfolio/releases/latest) version for production use!
