			...
			<Container spacing={['verticalXXXLrg']}>
				...
				<section className={career.area}>
						...
						<h3>Freelancer Developer</h3>
							...
							<p>
							I work as a full stack web and mobile developer providing web developer services for several companies.
							</p>
						</div>
						<div className={career.companyAlt}></div>

						<Badges list={freelancer} block="stack" fullContainer="fullContainer" color={undefined}/>
						</div>
						<div className={career.position}>
						...
						<h3>G4 Flex Business and Services</h3>
							...
							<p>
							I work as a systems analyst in the company&apos;s development sector, developing web solutions for the company&apos;s products.
							</p>
						</div>
						<div className={career.companyAlt}></div>
